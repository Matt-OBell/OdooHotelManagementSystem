...
var RoomSummary = AbstractField.extend({

    template : "room_summary_widget",
    ...
    init : function() {
        ...
        this.summary_header = this.record.data.summary_header;
        this.room_summary = [];
        console.log(this.record.data);
        this.on("change:date_from", this, function() {
            // this.set({"date_from": time.str_to_datetime(this.get_field_value("date_from"))});
            console.log('AJepe.............................................');
        });
        // this.on("change:date_to", this, function() {
        //     this.set({"date_to": time.str_to_datetime(this.get_field_value("date_to"))});
        // });
            
        // this.on("change:summary_header", this, function() {
        //     this.set({"summary_header": this.get_field_value("summary_header")});
        // });
        // this.on("change:room_summary", this, function() {
        //     this.set({"room_summary":this.get_field_value("room_summary")});
        // });
        // this.on('change:date_from', this, function(){console.log('Ajepe......................Babatope')});
        // console.log(this)
    },

});

Registry.add('room_summary_widget', RoomSummary);
return RoomSummary
});
